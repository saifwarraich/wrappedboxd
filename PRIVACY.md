# Privacy Policy for Unboxd

**Last updated:** 2026-08-12

Unboxd is a Chrome extension that adds a statistics panel to Letterboxd profile pages. This policy explains what data the extension accesses, how it's used, and what is (and isn't) shared.

## What data Unboxd accesses

- **Website content** — Unboxd reads film titles, ratings, watch dates, and related activity from Letterboxd pages you visit and from Letterboxd data exports (CSV files) you choose to upload, in order to compute and display your viewing statistics.
...
Unboxd does **not** collect names, email addresses, passwords, payment information, location data, health information, or your browsing history on other websites.
...
Unboxd makes requests to three destinations, and only for the purposes below:
...
Unboxd does not sell or transfer user data to third parties, does not use your data for purposes unrelated to displaying your Letterboxd statistics, and does not use your data to determine creditworthiness or for lending purposes.
...
Questions about this policy can be directed via the [GitHub repository](https://github.com/saifwarraich/unboxd).
